...
Edition](http://www.lemis.com/grog/Documentation/Lions/). In addition, we also use the popular
online OS book [Operating Systems: Three Easy
Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/#book-chapters) by Remzi H. Arpaci-Dusseau and Andrea
C. Arpaci-Dusseau. The goal is to deepen the understanding of basic OS concepts and UNIX's
...
| 1/14 | 2    | 3         | TRB: Ch. 7-9 (S1)                                     | Ch. 2-6 (Q0)   |
| 1/17 |      | 4         | TRB: Ch. 10-13 (S2)                                   |                |
| 1/21 | 3    | 5         | TRB: Ch. 14-16 (S3)                                   | Ch. 7-13 (Q1)  |
| 1/24 |      | 6         | TRB: Ch. 17-20 (S4)                                   |                |
| 1/28 | 4    | 7         | WOR: Freestanding Binary, Minimal Kernel, & VGA (S5)  | Ch. 14-20 (Q2) |
| 1/31 |      | 8         | WOR: Testing & CPU Exceptions (S6)                    |                |
| 2/4  | 5    | 9         | WOR: Double Faults & Hardware Interrupts (S7)         | Past week (Q3) |
| 2/7  |      | 10        | WOR: Intro to Paging & Paging Implementation (S8)     |                |
| 2/11 | 6    | 11        | WOR: Heap Allocation & Allocator Designs (S9)         | Past week (Q4) |
...
* Quizzes (Q1 - Q10): 10 * 4% = 40%
* Submissions (S1 - S10): 10 * 2% = 20%
* Submissions (S11 - S13): 3 * 6% = 18%
* Final: 22%
